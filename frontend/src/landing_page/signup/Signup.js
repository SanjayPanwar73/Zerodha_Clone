...
//       const { data } = await axios.post("http://localhost:3001/api/signup", {email, username, password}, { 
...
//         <img src="media/images/signup.png" style={{width: "45%", paddingRight: "4rem"}}></img>
