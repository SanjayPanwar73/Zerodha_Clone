...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!API) {
      handleError("API URL is not defined. Check your .env file.");
      return;
    }
  ...
  return (
    <div className="container" style={{ marginTop: "11rem" }}>
      ...
      <div className="d-flex flex-column flex-md-row justify-content-center align-items-center mb-5">
        {/* Image */}
        <div
          className="order-1 order-md-1 mb-4 mb-md-0 text-center"
          style={{ width: "100%", maxWidth: "500px", paddingRight: "2rem" }}
        >
          <img
            src="media/images/signup.png"
            className="img-fluid"
      ...
      <h1
        ...
        style={{ marginTop: "5.5rem", marginBottom: "5.5rem" }}
      >
        Investment options with Zerodha demat account
      </h1>
