...
app.post("/sellOrder", async (req, res) => {
  let selledOrder = new OrdersModel(req.body);
  await selledOrder.save();
...
// Copy build folders into backend/public/frontend and backend/public/dashboard
...
// --- Root check ---
app.get("/", (req, res) => {
  res.send("Welcome to Zerodha Clone Backend + Frontend + Dashboard");
});
